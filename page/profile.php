                        ...
                        <div class="row p-2">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nama" id="name" value="<?= $user['nama'] ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="nik" class="form-label">Nomor NIK</label>
                                    <input type="number" class="form-control read" name="nik" id="nik" value="<?= $user['nik'] ?>" disabled readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
